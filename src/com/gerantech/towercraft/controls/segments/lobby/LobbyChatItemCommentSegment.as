...
override public function commitData(_data:ISFSObject, index:int):void
{
	...
	switch(data.getInt("m"))
	{
		...
		case MessageTypes.M13_COMMENT_PROMOTE:		comment = loc("lobby_comment_promote",	[data.getUtfString("o"), data.getUtfString("s"), loc("lobby_role_"+data.getInt("p"))]);	break;
		case MessageTypes.M14_COMMENT_DEMOTE:		comment = loc("lobby_comment_demote",	[data.getUtfString("o"), data.getUtfString("s"), loc("lobby_role_"+data.getInt("p"))]);	break;
	}
