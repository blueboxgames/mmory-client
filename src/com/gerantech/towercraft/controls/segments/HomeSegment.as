...
override public function init():void
{
	...
	eventsButton.data = player.prefs.getAsInt(PrefsTypes.SETTINGS_6_CHALLENGE_INDEX) == -1 ? 0 : player.prefs.getAsInt(PrefsTypes.SETTINGS_6_CHALLENGE_INDEX);
...
private function mainButtons_triggeredHandler(event:Event):void
{
	...
	switch( buttonName )
	{
		...
		case "battleButton":	appModel.navigator.runBattle(player.prefs.getAsInt(PrefsTypes.SETTINGS_6_CHALLENGE_INDEX) == -1 ? 0 : player.prefs.getAsInt(PrefsTypes.SETTINGS_6_CHALLENGE_INDEX));	return;
	}
