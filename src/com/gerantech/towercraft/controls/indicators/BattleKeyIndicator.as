...
override protected function initialize():void
{
	...
	bgImage.source = appModel.assets.getTexture("theme/indicator-background");
	bgImage.alpha = 0.7;
	...
	labelDisplay.textFormat = new BitmapFontTextFormat(appModel.assets.getFont(), size*4, color, "center");
	...
	iconDisplay.source = appModel.assets.getTexture("res-1004");
	labelDisplay.pixelSnapping = false;
