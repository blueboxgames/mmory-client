...
{		
	...
	nativeFilters = [new GlowFilter(shadowColor, 1, elementFormat.fontSize * 0.03, elementFormat.fontSize * 0.03, elementFormat.fontSize * 0.1), new DropShadowFilter(elementFormat.fontSize * 0.03, 90, shadowColor, 1, 0, 0) ];
}
}
}