...
override protected function initialize():void
{
	...
	var bgImage:Image = new Image(appModel.assets.getTexture("healthbar-bg--1"));
	bgImage.alpha = 0.6;
	...
	allisFill.source = appModel.assets.getTexture("healthbar-fill-0");
	allisFill.layoutData = new AnchorLayoutData(NaN, 0, 0, 0);
	allisFill.scale9Grid = bgImage.scale9Grid;
	addChild(allisFill);
	
	axisFill = new ImageLoader();
	axisFill.source = appModel.assets.getTexture("healthbar-fill-1");
